 ...
 */
public class HlsRendererBuilder implements HachiPlayer.RendererBuilder {
    ...
    @Override
    public void buildRenderers(HachiPlayer player) {
    ...
    private static final class AsyncRendererBuilder implements ManifestFetcher.ManifestCallback<HlsPlaylist> {
        ...
        private final Context context;
        private final String userAgent;
        private final HachiPlayer player;
        private final ManifestFetcher<HlsPlaylist> playlistFetcher;

        private boolean canceled;

        public AsyncRendererBuilder(Context context, String userAgent, String url, HachiPlayer player) {
            this.context = context;
            this.userAgent = userAgent;
            this.player = player;
        ...
        public void onSingleManifest(HlsPlaylist manifest) {
            ...
            HlsSampleSource sampleSource = new HlsSampleSource(chunkSource, loadControl,
                MAIN_BUFFER_SEGMENTS * BUFFER_SEGMENT_SIZE, mainHandler, player, HachiPlayer.TYPE_VIDEO);
            ...
            if (haveSubtitles) {
                ...
                HlsSampleSource textSampleSource = new HlsSampleSource(textChunkSource, loadControl,
                    TEXT_BUFFER_SEGMENTS * BUFFER_SEGMENT_SIZE, mainHandler, player, HachiPlayer.TYPE_TEXT);
                textRenderer = new TextTrackRenderer(textSampleSource, player, mainHandler.getLooper());
            } else {
                textRenderer = new Eia608TrackRenderer(sampleSource, player, mainHandler.getLooper());
            }

            TrackRenderer[] renderers = new TrackRenderer[HachiPlayer.RENDERER_COUNT];
            renderers[HachiPlayer.TYPE_VIDEO] = videoRenderer;
            renderers[HachiPlayer.TYPE_AUDIO] = audioRenderer;
            renderers[HachiPlayer.TYPE_METADATA] = id3Renderer;
            renderers[HachiPlayer.TYPE_TEXT] = textRenderer;
