...
import com.waylens.hachi.actions.PlaylistOperations;
import com.waylens.hachi.actions.SelectAudio;
...
abstract public class VdbEdit {
    ...
    private void startDownload(DownloadInfoEx downloadInfo, int stream, Clip.StreamInfo si) {
        ...
        if (isEditingClip || mEditor.isEditingPlaylist(downloadInfo.cid)) {
            ...
            DownloadInfoEx.DownloadStreamInfo dsi = stream == 0 ? downloadInfo.main : downloadInfo.sub;
