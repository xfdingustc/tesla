...
/**
 * Created by lshw on 16/9/1.
 */
public class ClipInfoRequest extends VdbRequest<Clip> {
    ...
    public ClipInfoRequest(Clip.ID cid, int flag, int type, int attr,
                           VdbResponse.Listener<Clip> listener,
    ...
    protected VdbCommand createVdbCommand() {
        mVdbCommand = VdbCommand.Factory.createCmdGetClipInfo(mCid, mType, mFlag);
        return mVdbCommand;
    }
    ...
    protected VdbResponse<Clip> parseVdbResponse(VdbAcknowledge response) {
        ...
        Clip clip = new Clip(0, clipId, null, clipDate, startTimeMs, duration);
        ...
        clip.cid.type = response.readi32(); //int clipType
