...
public class BottomBar extends LinearLayout implements View.OnClickListener, View.OnLongClickListener {
    ...
    public void setOnCenterTabClickListener(@Nullable OnCenterTabClickListener listener) {
        onCenterTabClickListener = listener;
    }
    ...
    private void handleClick(View v) {
        ...
        if (newTab.isCenterTab()) {
            Logger.t(TAG).d("center tab is clicked");
            if (onCenterTabClickListener != null) {
                onCenterTabClickListener.onCenterTabClick();
            }
        } else {
