package com.waylens.hachi.ui.views.radarview;
...
//    private Bitmap centerBitmap;//最中间icon
    ...
    private void init() {
        ...
        mPaintLine.setColor(getResources().getColor(R.color.app_text_color_primary_light));
...
//        centerBitmap = BitmapFactory.decodeResource(getResources(), R.drawable.circle_photo);
        ...
        scanShader = new SweepGradient(mWidth / 2, mHeight / 2,
            new int[]{Color.TRANSPARENT, getResources().getColor(R.color.app_text_color_primary)}, null);
    }
