...
public class VdbCommand {
    ...
    public static class Factory {
        ...
        public static VdbCommand createCmdGetClipInfo(Clip.ID cid, int type, int flag) {
            return new Builder()
                .writeCmdCode(VDB_CMD_GetClipInfo, 0)
                .writeClipId(cid)
                .writeInt32(flag)
                .build();
        }
        ...
        public static VdbCommand createCmdAddBookmark(Clip.ID cid, long startTimeMs, long endTimeMs) {
            return new Builder()
