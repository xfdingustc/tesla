...
public class SectorSeekbar extends View {
    ...
    private void initViewAttrs(AttributeSet attrs){
        ...
        TypedArray localTypedArray = mContext.obtainStyledAttributes(attrs, R.styleable.SectorSeekBar);
        ...
        mThumbDrawable = localTypedArray.getDrawable(R.styleable.SectorSeekBar_android_thumb);
        ...
        float progressWidth = localTypedArray.getDimension(R.styleable.SectorSeekBar_progress_width, 5);
        int progressBackgroundColor = localTypedArray.getColor(R.styleable.SectorSeekBar_progress_background, Color.GRAY);
        int progressFrontColor = localTypedArray.getColor(R.styleable.SectorSeekBar_progress_front, Color.BLUE);
        mSeekBarMax = localTypedArray.getInteger(R.styleable.SectorSeekBar_progress_max, 100);
        ...
        mIsShowProgressText = localTypedArray.getBoolean(R.styleable.SectorSeekBar_show_progress_text, false);
        int progressTextStroke = (int) localTypedArray.getDimension(R.styleable.SectorSeekBar_progress_text_stroke_width, 5);
        int progressTextColor = localTypedArray.getColor(R.styleable.SectorSeekBar_progress_text_color, Color.GREEN);
        mProgressTextSize = (int) localTypedArray.getDimension(R.styleable.SectorSeekBar_progress_text_size, 50);
