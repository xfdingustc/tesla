 ...
 */
public class DownloadUrlRequest extends VdbRequest<VdbClient.DownloadInfoEx> {
    private static final String TAG = DownloadUrlRequest.class.getSimpleName();

    private final VdbResponse.Listener<VdbClient.DownloadInfoEx> mListener;
    ...
    public DownloadUrlRequest(Clip clip, VdbResponse.Listener<VdbClient
        .DownloadInfoEx> listener, VdbResponse.ErrorListener errorListener) {
        this(0, clip, listener, errorListener);
    }

    public DownloadUrlRequest(int method, Clip clip, VdbResponse.Listener<VdbClient
        .DownloadInfoEx> listener, VdbResponse.ErrorListener errorListener) {
    ...
    @Override
    protected VdbResponse<VdbClient.DownloadInfoEx> parseVdbResponse(VdbAcknowledge response) {
        ...
        VdbClient.DownloadInfoEx downloadInfo = new VdbClient.DownloadInfoEx(cid);
    ...
    @Override
    protected void deliverResponse(VdbClient.DownloadInfoEx response) {
