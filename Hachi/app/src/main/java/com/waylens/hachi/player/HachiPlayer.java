 ...
 */
public class HachiPlayer implements ExoPlayer.Listener, ChunkSampleSource.EventListener,
    ...
    public interface RendererBuilder {
        ...
        void buildRenderers(HachiPlayer player);
    ...
    public HachiPlayer(RendererBuilder rendererBuilder) {
