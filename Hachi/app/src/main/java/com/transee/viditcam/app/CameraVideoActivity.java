...
public class CameraVideoActivity extends BaseActivity {
	...
	static final String TAG = "CameraVideoActivity";
	...
	class MyCameraVideoList extends CameraVideoList {
		...
		@Override
		void onClickClipItem(Bitmap bitmap, Clip clip, int offset, int size) {
		...
		@Override
		void onClickPlaylistItem(Bitmap bitmap, Playlist playlist) {
			if (!isEditing()) {
