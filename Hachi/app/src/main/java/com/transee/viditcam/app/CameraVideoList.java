...
abstract public class CameraVideoList {
	...
	abstract void onClickClipItem(Bitmap bitmap, Clip clip, int offset, int size);

	abstract void onClickPlaylistItem(Bitmap bitmap, Playlist playlist);
	...
	class MyNewClipSetAdapter extends ClipSetAdapter {
		...
		@Override
		void onClickClipItem(int index, int offset, int size, Clip clip, Bitmap bitmap) {
	...
	class MyNewPlaylistSetAdapter extends PlaylistSetAdapter {
		...
		@Override
		void onClipPlaylistItem(int index, Playlist playlist, Bitmap bitmap) {
