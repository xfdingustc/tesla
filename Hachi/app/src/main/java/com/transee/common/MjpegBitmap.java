...
public class MjpegBitmap extends View {
	...
	public MjpegBitmap(Context context, AttributeSet attrs) {
		super(context, attrs);
		initView();
	}

	public MjpegBitmap(Context context, AttributeSet attrs, int defStyle) {
	...
	private class MyGestureListener implements GestureDetector.OnGestureListener {
		...
		public boolean onSingleTapUp(MotionEvent e) {
			MjpegBitmap.this.onSingleTapUp(e);
			return true;
		}

		@Override
		public boolean onScroll(MotionEvent e1, MotionEvent e2, float distanceX, float distanceY) {
			MjpegBitmap.this.onScroll(e1, e2, distanceX, distanceY);
			return true;
		}
		...
		public boolean onFling(MotionEvent e1, MotionEvent e2, float velocityX, float velocityY) {
			MjpegBitmap.this.onFling(e1, e2, velocityX, velocityY);
			return true;
		}
