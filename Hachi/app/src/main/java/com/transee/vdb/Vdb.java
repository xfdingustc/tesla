...
abstract public class Vdb {
	...
	public interface Callback {
		...
		void onRawDataResult(Vdb vdb, RawDataResult rawDataResult);

		void onRawDataBlock(Vdb vdb, RawDataBlock block);

		void onDownloadRawDataBlock(Vdb vdb, DownloadRawDataBlock block);
	...
	protected void handleGPSDataBlock(RawDataBlock block) {
		RawDataBlockHeader header = block.header;
	...
	protected class VdbClientCallback implements VdbClient.Callback {
		...
		@Override
		public void onRawDataResultAsync(final RawDataResult rawDataResult) {
			mHandler.post(new Runnable() {
				@Override
				public void run() {
		...
		@Override
		public void onDownloadRawDataBlockAsync(final DownloadRawDataBlock block) {
			mHandler.post(new Runnable() {
				@Override
				public void run() {
