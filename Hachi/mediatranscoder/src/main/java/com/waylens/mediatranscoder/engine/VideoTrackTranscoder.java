...
import com.waylens.mediatranscoder.engine.surfaces.OutputSurface;
import com.waylens.mediatranscoder.engine.surfaces.OverlaySurface;
import com.waylens.mediatranscoder.format.MediaFormatExtraConstants;
...
public class VideoTrackTranscoder implements TrackTranscoder {
    ...
    private OverlaySurface mOverlaySurfaceWrapper = null;
    ...
    private OverlayProvider mOverlayProvider = null;

    public VideoTrackTranscoder(MediaExtractor extractor, int trackIndex, MediaFormat outputFormat,
                                QueuedMuxer muxer, OverlayProvider overlayProvider) {
    ...
    public void setup() {
        ...
        if (mOverlayProvider != null) {
            mOverlaySurfaceWrapper = new OverlaySurface(mOverlayProvider);
        }
    }
    ...
    public void release() {
        ...
        if (mOverlaySurfaceWrapper != null) {
            mOverlaySurfaceWrapper.release();
            mOverlaySurfaceWrapper = null;
        }
        if (mDecoder != null) {
    ...
    private int drainDecoder(long timeoutUs) {
        ...
        if (doRender) {
            ...
            if (mOverlaySurfaceWrapper != null) {
                ...
                mOverlaySurfaceWrapper.drawImage(mBufferInfo.presentationTimeUs * 1000, mSTMatrix);
            }
